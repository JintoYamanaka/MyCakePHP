...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'college' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-15 00:20:09',
                'modified' => '2018-08-15 00:20:09'
            ],
        ];
        parent::init();
    }
